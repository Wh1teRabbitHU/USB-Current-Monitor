...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, STATUS_LED_Pin|ERROR_LED_Pin|DISPLAY_BLACKLIGHT_EN_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DISPLAY_DC_Pin|DISPLAY_CS_Pin|DISPLAY_SCL_Pin|DISPLAY_SDA_Pin
                          |DISPLAY_RESET_Pin|PATH_1_EN_Pin|PATH_2_EN_Pin|MUX_A0_Pin
                          |MUX_A1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = DISPLAY_DC_Pin|DISPLAY_CS_Pin|DISPLAY_SCL_Pin|DISPLAY_SDA_Pin
                          |DISPLAY_RESET_Pin|DISPLAY_BLACKLIGHT_EN_Pin|PATH_1_EN_Pin|PATH_2_EN_Pin
                          |MUX_A0_Pin|MUX_A1_Pin;
